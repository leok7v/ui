...
typedef struct {
    ...
    const char** env;
    int32_t (*option_index)(int32_t argc, const char* argv[], const char* option);
    ...
    */
    bool (*option_int)(int32_t *argc, const char* argv[], const char* option, int64_t *value);
    /* argc=3 argv={"foo", "--path", "bar"} -> returns "bar" argc=1 argv={"foo"} */
    const char* (*option_str)(int32_t *argc, const char* argv[], const char* option);
